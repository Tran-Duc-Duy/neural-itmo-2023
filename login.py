...
"/* Set style for app title widget */\n"
"#titleWidget {\n"
"	border-image: url(:/images/images/images/PyDracula_vertical.png);\n"
...
"background-color: rgb(85, 170, 255);")
        ...
        self.gridLayout.addWidget(self.titleWidget, 0, 0, 2, 1)
        ...
        self.funcWidget.setStyleSheet(u"border-top-right-radius:10px;\n"
"border-bottom-right-radius:10px;")
        self.page = QWidget()
...
"}")
        ...
        self.lineEdit.setText("tranduy123")
        ...
        self.lineEdit_2.setText("123456Duy!")
...
"}")
        ...
        self.gridLayout.addWidget(self.funcWidget, 0, 1, 2, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.registerBtn.setText(QCoreApplication.translate("Form", u"Go to register", None))
